...
export function CartItem(props) {
  ...
  return (
    <Card sx={{ width: 800, height: 230, border: 0.05 }}>
            ...
            <ListItem>
              ...
              >
                <MenuItem
                  ...
                  disabled={
                    item.sizes != null
                      ? item.sizes.find((x) => x.name === item.size).amount < 1
                      : item.totalQty < 1
                  }
                >
                  1
                ...
                <MenuItem
                  ...
                  disabled={
                    item.sizes != null
                      ? item.sizes.find((x) => x.name === item.size).amount < 2
                      : item.totalQty < 2
                  }
                >
                  2
                ...
                <MenuItem
                  ...
                  disabled={
                    item.sizes != null
                      ? item.sizes.find((x) => x.name === item.size).amount < 3
                      : item.totalQty < 3
                  }
                >
                  3
                ...
                <MenuItem
                  ...
                  disabled={
                    item.sizes != null
                      ? item.sizes.find((x) => x.name === item.size).amount < 4
                      : item.totalQty < 4
                  }
                >
                  4
                ...
                <MenuItem
                  ...
                  disabled={
                    item.sizes != null
                      ? item.sizes.find((x) => x.name === item.size).amount < 5
                      : item.totalQty < 5
                  }
                >
                  5
      ...
      {item.sizes != null
        ? item.sizes.find((x) => x.name === item.size).amount < 6 && (
            <Typography
              sx={{
                position: "absolute",
                bottom: 50,
            ...
            >
              Only {item.sizes.find((x) => x.name === item.size).amount} left!
            </Typography>
          )
        : item.totalQty < 6 && (
            <Typography
